'''
testing for the arlyn driver over a TCP connection
...
SCALE_ADDRESS_TCP = '172.16.206.47:10001' #ex: '192.168.1.12:4001'

@pytest.mark.asyncio
async def test_get_weight_string_TCP_connection() -> None:
    async with Scale(SCALE_ADDRESS_TCP) as scale:
